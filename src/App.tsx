...
export const App = () => {
  ...
  const [clicked, setClicked] = useState('customers');
    ...
    <div className="page__container">
      <nav className="menu" id="menu" ref={menu}>
        <a href="#" className="menu__logo">
          <img
            ...
            src="images/setting 1.svg"
            alt="logo"
          />
          <p className="menu__logo--p">
            Dashboard
            <span className="menu__logo--version">v.01</span>
          </p>
        </a>
            ...
            >
              <div className="menu__link-container">
                ...
                >
                  ...
                  <path d="M12 18.5201C11.59 18.5201 11.25 18.1801 11.25 17.7701V12.3301C11.25 11.9201 11.59 11.5801 12 11.5801C12.41 11.5801 12.75 11.9201 12.75 12.3301V17.7701C12.75 18.1801 12.41 18.5201 12 18.5201Z" />
            ...
            >
              <div className="menu__link-container">
                ...
                >
                  ...
                  <path d="M8.99945 15.7495C8.80945 15.7495 8.61945 15.6795 8.46945 15.5295C8.17945 15.2395 8.17945 14.7595 8.46945 14.4695L14.4695 8.46945C14.7595 8.17945 15.2395 8.17945 15.5295 8.46945C15.8195 8.75945 15.8195 9.23951 15.5295 9.52951L9.52945 15.5295C9.37945 15.6795 9.18945 15.7495 8.99945 15.7495Z" />
                </svg>
                Promote
              </div>
        ...
        <div className="menu__account">
          <img
            ...
            alt=""
            className="menu__account-photo"
          />
          <div className="menu__account-name">
            Evano
            <div className="menu__account-role">Project Manager</div>
          </div>
        </div>
      </nav>
      ...
      <main className="main">
        <div className="main__top">
          ...
          <h1 className="main__hello">Hello Evano 👋🏼,</h1>
        </div>

        <div className="main__container">
          <div className="main__header">
            <h2 className="main__header-title">All Customers</h2>

            <h3 className="main__header-subTitle">Active Members</h3>

            <div className="main__header-search">
              <img
                className="main__header-search--svg"
                src="images/search.svg"
                alt="search"
              />
              <input
                className="main__header-search--input"
                type="text"
                placeholder="Search"
              />
            </div>
          ...
          <div className="main__footer">
            ...
            <ul className="pagination">
              ...
              <li className={true ? 'page-item disabled' : 'page-item'}>
                <a
                  data-cy="nextLink"
                  className="page-link"
                  href="#next"
